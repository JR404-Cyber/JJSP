  ...
  return (
    ...
    <div className="max-width homeContainer">
      <div className="home-content">
        <div className="text-2"> Md.Julfikar Rayim</div>
        ...
        <div className=" iconContainer">
          {/* Facebook */}
          <a href="https://www.facebook.com/profile.php?id=100079300536071" target="_blank" rel="noreferrer">
          ...
          {/* linkedin */}
          <a href="https://www.instagram.com/mr.julfikarrayim/#" target="_blank" rel="noreferrer">
          ...
          {/* Gmail */}
          <a href="mailto:julfikarrayim@gmail.com">
          ...
          {/* Github */}
          <a href="https://github.com/JR404-Cyber" target="_blank" rel="noreferrer">
        ...
        <br/>
        <a href="mailto:julfikarrayim@gmail.com" className="hire about-img pointer">Hire me</a>
      </div>
