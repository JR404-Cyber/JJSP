...
function Contact() {
    ...
    function sendEmail(e) {
        ...
        axios
        .post(
            'https://email-api-elmo.onrender.com/contactus/send/to:julfikarrayim@gmail.com&sub:portfolio_contact',
            contactData,
            {
                ...
                <div className="icons">
                    <div className="row">
                        ...
                        <div className="info">
                            ...
                            <div className="sub-title">Md.Julfikar Rayim</div>
                        </div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="info">
                            ...
                            <div className="sub-title">julfikarrayim@gmail.com</div>
                        </div>
                    </div>
                </div>
            </div>
