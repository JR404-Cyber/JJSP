        ...
        <div className="max-width">
            ...
            <div className="about-content">
                ...
                <div className="column right about-img" style={{padding: "20px", borderRadius: "10px"}} data-aos="fade-left" >
                    ...
                    <p>
                      I{`'`}m Md.Julfikar Rayim and I{`'`}m a passionate web developer. From a young age, I{`'`}ve loved creating things and solving problems. When I discovered programming, I knew it was the perfect outlet for my interests. Within a year and a half of learning, I landed my first job and gained valuable experience working on real projects.
